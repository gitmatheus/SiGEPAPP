...
/*
     *Funções para Gravar e Ler Cookies*/
    ...
    $.post("LoginServlet",{
        ...
        if(confirma != 0){// se 1, exibe codigo html na posicao do elemento identificado como syslogin
            $("#syslogin").html(
                ...
                "<br /><a id='avalia_docs' href='frmAvaliacoesPendentes.jsp' class='painelcontrole' title='Lista as avaliações dos documentos'>Lista de avalia&ccedil;&otilde;es</a>" +
