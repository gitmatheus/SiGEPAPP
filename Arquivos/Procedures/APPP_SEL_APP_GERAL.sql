...
* APPP_SEL_APP_GERAL  : Procedure para SELECIONAR dados de PATTERNS OU ANTI-PATTERNS
* Author              : WeeDo 
* History             : 11/05/2009 - Matheus Goncalves
***********************************************************************************************************************/
create or replace procedure APPP_SEL_APP_GERAL(p_cursor OUT SYS_REFCURSOR,
