...
begin
    ...
    ELSE      
       ...
       WHERE (lower(AO.NM_ATRIBUTO_OBJ) LIKE ('%'|| lower(pNM_ATRIBUTO_OBJ) || '%') OR pNM_ATRIBUTO_OBJ IS NULL)
       AND   (lower(AO.DS_ATRIBUTO_OBJ) LIKE ('%'|| lower(pDS_ATRIBUTO_OBJ) || '%') OR pDS_ATRIBUTO_OBJ IS NULL)
