...
public final class frmCadUsuario_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 out.print(request.getSession().getAttribute("usuario"));
      ...
      out.write("\t\t//function verificaExisteLogin(){\r\n");
      out.write("\t\t\tvar login = $(\"#frmCadUserLogin\").val();\r\n");
      out.write("\t\t\t$.post(\"ExisteLoginServlet\",{login:login},function(xml){\r\n");
      out.write("\t\t\t\tif($(\"liberado\",xml).text() == \"sim\"){\r\n");
      out.write("\t\t\t\t\talert(\"Login disponivel!\");\r\n");
      out.write("\t\t\t\t}else{\r\n");
      out.write("\t\t\t\t\talert(\"Login existente\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("//\t\t}\r\n");
      out.write("\t\t});\r\n");
