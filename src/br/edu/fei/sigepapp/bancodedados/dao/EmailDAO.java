...
public class EmailDAO implements DAO<Email> {
        ...
        try {
            ...
            PreparedStatement stmt =
                this.conn.prepareStatement(
                    "insert into appp_tb_user_email (cd_user, nm_email, tp_email) values( ?, ?, ?)");
            ...
            GravarLog.gravaInformacao(Email.class.getName() + ": insercao no banco de dados realizada com sucesso");
            ...
            GravarLog.gravaErro(Email.class.getName() + ": erro na insercao referente a uma excecao de SQL: "
                                + e.getMessage());
    ...
    public boolean atualiza(Email email) {
        try {
            ...
            PreparedStatement stmt =
                this.conn.prepareStatement("update appp_tb_user_email set nm_email=?, tp_email=? where cd_user=?)");
            ...
            // Grava log com a informa��o de sucesso
            GravarLog.gravaInformacao(Email.class.getName() + ": atualizacao no banco de dados realizada com sucesso");
            ...
            // Grava log com o erro que ocorreu durante a execucao do comando SQL
            GravarLog.gravaErro(Email.class.getName() + ": erro na atualizacao referente a uma excecao de SQL: "
                                + e.getMessage());
    ...
    public boolean deleta(Email email) {
        try {
            ...
            // Grava log com a informa��o de sucesso
            GravarLog.gravaInformacao(Email.class.getName() + ": remocao no banco de dados realizada com sucesso");
            ...
            // Grava log com o erro que ocorreu durante a execucao do comando SQL
            GravarLog.gravaErro(Email.class.getName() + ": erro na remocao referente a uma excecao de SQL: "
                                + e.getMessage());
    ...
    public List<Email> seleciona(String query) {
        try {
            ...
            // Grava log com o erro que ocorreu durante a execucao do comando SQL
            GravarLog.gravaErro(Email.class.getName() + ": erro na pesquisa referente a uma excecao de SQL: "
                                + e.getMessage());
