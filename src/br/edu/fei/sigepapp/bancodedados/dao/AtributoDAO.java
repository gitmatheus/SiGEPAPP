    ...
    public List<Atributo> PreencheList(ResultSet rs) throws SQLException {
        ...
        while (rs.next()) {
            ...
            for (int i = 1; i <= rs.getMetaData().getColumnCount(); i++) {
                ...
                switch (selecao) {
                    case 0:
                        atributoNovo.setCd_atributo_obj(rs.getLong(i));break;
                    case 1:
                        atributoNovo.setNm_atributo_obj(rs.getString(i));break;
                    case 2:
                        atributoNovo.setDs_atributo_obj(rs.getString(i));break;
                    case 3:
                        atributoNovo.setDs_tam_atrib(rs.getString(i));break;
                    case 4:
                        atributoNovo.setCd_tipo(rs.getLong(i));break;
                    case 5:
                        atributoNovo.setFl_atrib_relac(rs.getString(i));break;
                }
