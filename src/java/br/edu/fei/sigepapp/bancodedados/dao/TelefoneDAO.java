...
public class TelefoneDAO implements DAO<Telefone> {
    ...
    public boolean adiciona(Telefone telefone) {
        try {
            ...
            PreparedStatement stmt =
                this.conn.prepareStatement("insert into appp_tb_user_telefone (cd_user, nr_ddi, nr_ddd,"
            ...
            GravarLog.gravaInformacao(Telefone.class.getName() + ": insercao no banco de dados realizada com sucesso");
            ...
            GravarLog.gravaErro(Telefone.class.getName() + ": erro na insercao referente a uma excecao de SQL: "
                                + e.getMessage());
    ...
    public boolean atualiza(Telefone telefone) {
        try {
            ...
            PreparedStatement stmt =
                this.conn.prepareStatement("update appp_tb_user_telefone set nr_ddi=?, nr_ddd=?, nr_telefone=?,"
            ...
            // Grava log com a informa��o de sucesso
            GravarLog.gravaInformacao(Telefone.class.getName()
            ...
            // Grava log com o erro que ocorreu durante a execucao do comando SQL
            GravarLog.gravaErro(Telefone.class.getName() + ": erro na atualizacao referente a uma excecao de SQL: "
                                + e.getMessage());
    ...
    public boolean deleta(Telefone telefone) {
        try {
            ...
            // Grava log com a informa��o de sucesso
            GravarLog.gravaInformacao(Telefone.class.getName() + ": remocao no banco de dados realizada com sucesso");
            ...
            // Grava log com o erro que ocorreu durante a execucao do comando SQL
            GravarLog.gravaErro(Telefone.class.getName() + ": erro na remocao referente a uma excecao de SQL: "
                                + e.getMessage());
    ...
    public List<Telefone> seleciona(String query) {
        try {
            ...
            // Grava log com o erro que ocorreu durante a execucao do comando SQL
            GravarLog.gravaErro(Telefone.class.getName() + ": erro na pesquisa referente a uma excecao de SQL: "
                                + e.getMessage());
